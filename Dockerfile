...
# https://k3d.io/v5.8.3/usage/advanced/cuda/#building-a-customized-k3s-image
# For Kubernetes versions https://docs.k3s.io/release-notes/v1.31.X
# For CUDA:  https://hub.docker.com/r/nvidia/cuda/tags

# Define ARGs for build-time variables
# Find CUDA compatible with NVIDIA_DRIVER_VERS
# https://medium.com/%40biswal.anwesh29/cuda-connundrum-on-compatibilty-and-further-discussions-on-drivers-cuda-toolkits-5391330c8916
# https://docs.nvidia.com/deploy/pdf/CUDA_Compatibility.pdf

# Define ARGs early so they're accessible in all FROM stages
